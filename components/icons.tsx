...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M22 2L20 7L15 9L20 11L22 16L24 11L29 9L24 7L22 2Z" transform="translate(-8 -1) scale(0.5)"></path>
     <path d="M2 22L4 17L9 15L4 13L2 8L0 13L-5 15L0 17L2 22Z" transform="translate(6 1) scale(0.5)"></path>
  </svg>
);

export const WandIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8 19 13"/><path d="M15 9a3 3 0 0 0-3-3"/><path d="M12 12a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v6a3 3 0 0 0 3 3h3a3 3 0 0 0 3-3v-1a3 3 0 0 0-3-3H9"/><path d="m19 5-1.8 1.8"/><path d="M22 22 12 12"/></svg>
);
...
export const CropIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
...
export const CheckIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><polyline points="20 6 9 17 4 12"/></svg>
);
...
export const FlipHorizontalIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 7v10h18V7M3 12h18"/><path d="m16 3-4 4-4-4"/></svg>
);

export const FlipVerticalIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M7 3H3v18h4M12 3v18"/><path d="m21 16-4-4 4-4"/></svg>
);

export const EyedropperIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m2 22 5.5-5.5"/><path d="m13.02 13.02 5.5-5.5"/><path d="M14.5 6.5 22 14"/><path d="m13.02 13.02 2.12-2.12C16.6 9.42 16.07 7.5 15 7c-1.55-.78-3.5-1.3-5-2.5-1.5-1.2-2.03-3.08-1.52-4.48L2 6.5l3.5 3.5.02.02c1.4-1.4 3.55-1.98 5-1.52Z"/></svg>
);
